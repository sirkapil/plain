...
---
<div class="isa_info"><i class="fa fa-arrow-right" style="font-size:24px"></i><b>Introduction:</b> <br /><p align="center">This is one of the Newton-Cotes Formulae used for evaluating approximate numerical value of a definite integral.</p></div>
